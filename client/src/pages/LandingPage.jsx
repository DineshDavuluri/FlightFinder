    ...
    <div className="landingPage">
      <div className="landingHero">
        ...
        <div className="landingHero-title">
          <h1 className="banner-h1">Explore the Skies with <br></br>DD Flight Finder!</h1>
          <p className="banner-p">Book your next flight with ease and confidence. Whether you're heading home or planning your next adventure, DD Flight Finder—crafted by Dinesh Davuluri—makes flight booking simple, smart, and seamless.</p>
        </div>
      ...
      <section id="about" className="section-about  p-4">
        <div className="container">
          ...
          <p className="section-description">
            &nbsp;&nbsp;&nbsp;&nbsp;Welcome to <strong>DD Flight Finder</strong> — your one-stop solution for hassle-free flight bookings. Built with passion and precision by <strong>Dinesh Davuluri</strong>, this platform is designed to make your travel planning smoother and smarter.
          </p>
          <p className="section-description">
            &nbsp;&nbsp;&nbsp;&nbsp;From quick domestic getaways to cross-country adventures, DD Flight Finder empowers you to browse flights, compare fares, and secure tickets—all in just a few clicks. With real-time availability, clean design, and flexible options, planning your journey has never been this effortless.
          </p>
          <p className="section-description">
            &nbsp;&nbsp;&nbsp;&nbsp;At DD Flight Finder, we believe travel should be exciting, not exhausting. That’s why we’ve focused on speed, reliability, and user experience. Discover destinations, plan ahead, and take off with confidence. Your journey starts here.
          </p>

          <span><h5>2025 © DD Flight Finder – Developed by Dinesh Davuluri. All Rights Reserved.</h5></span>
        </div>
      </section>
    </div>
  )
